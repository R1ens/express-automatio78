...
def make_bounds(base_override: Optional[Dict[str, float]] = None) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
    ...
    bounds = {
        "L_st_position": (0.9000, 1.0500, 1.2000),
        "L_st_span": (0.12, 0.6, 1.00),
        "L_st": (0.1, 0.20, 0.35),
        "L_st_straight": (0.016, 0.1, 0.2),
        "delta_st": (0.02, 0.02, 0.03),
        "L_w_position": (2, 3.8, 7),
        "L_w_span": (0.7, 1.7, 2.5),
        "L_w": (0.5, 1.6, 2.5),
        "L_w_straight": (0.3, 0.50, 1),
        "delta_w": (0.03, 0.03, 0.04),
    }
