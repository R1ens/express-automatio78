...
# phi_min from "РЛС"
theta_0 = np.deg2rad(13.0)

# Target ("Цель")
V_target = 330.0
V_LO, V_HI = 1.5 * V_target, 2.5 * V_target  # 495 ... 825

# Altitudes
Y_min, Y_max = 1200.0, 10000.0

# Boundary points (match your "Расчет точек")
X_1, Y_1 = Y_max / np.tan(theta_0), Y_max  # ~43314.7587, 10000
X_4, Y_4 = Y_min / np.tan(theta_0), Y_min  # ~5197.7710, 1200
